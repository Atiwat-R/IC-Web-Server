...
// Compile -> gcc testweb.c -lpthread
// Run -> ./testweb thread_number request port
...
int main(int argc, char** argv){
    ...
    threads = strtol(argv[1], NULL, 10); // number of threads from input
    ...
    if (argc == 4){
        port = strtol(argv[3], NULL, 10); // port
